<nav class="fixed top-0 z-50 w-full bg-neutral-primary-soft border-b border-default">
    ...
    <path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M5 7h14M5 12h14M5 17h10"/>
            ...
            <img src="{{ asset('images/dentalsys_logo.png') }}" class="h-6 me-3" alt="DentalSys Logo" />
            <span class="self-center text-lg font-semibold whitespace-nowrap dark:text-white">DentalSys</span>
            </a>
        </div>
